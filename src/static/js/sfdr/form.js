...
dojo.declare("sfdr.form.selectfield", sfdr.form.field, {
    ...
    render : function(parent) {
        ...
        this.object = dojo.create("select", {
            name : this.name
        }, this.wrapper);
        for (o in this.options) {
            dojo.create("option", {
                innerHTML : this.options[o].txt,
...
dojo.declare("sfdr.form.listfield", sfdr.form.field, {
    ...
    render : function(parent) {
        ...
        // parent:
        // parent DOM node
        parent = dojo.create("div", {
            innerHTML : "<h2>" + this.title + "</h2>"
        }, parent);
...
dojo.declare("sfdr.form.form", null, {
    ...
    container : null,
    ul : null,
    constructor : function(cfg, container, submit) {
        // summary:
    ...
    render : function() {
        ...
        dojo.connect(dojo.create("input", {
            type : "button",
            value : "send"
        }, dojo.create("li", null, this.ul)), "onclick", this, this.send);
        for (l in this.lists) {
